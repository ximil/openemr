...
//Add 'Document Writer' object section (added in 4.1.0)
addObjectSectionAcl('docwriter','Document Writer');
...
//Add 'docwriter' object (added in 4.1.0)
addObjectAcl('docwriter', 'Document-Writer', 'dwr', 'Document-Writer');
...
//Insert the 'sign' object from the 'patients' section into the Physicians group write ACL (added in 3.3.0)
updateAcl($admin_write, 'Administrators','docwriter', 'Document-Writer', 'dwr', 'Document-Writer','write');
//Insert the 'sign' object from the 'patients' section into the Physicians group write ACL (added in 3.3.0)
updateAcl($emergency_write, 'Emergency Login','docwriter', 'Document-Writer', 'dwr', 'Document-Writer','write');
