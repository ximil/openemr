	...
	<table width="1004" border="0" style="border:1px solid black" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		...
		<?php
		  ...
		  {
		  ?>
			<?php htmlspecialchars( xl('Confirm Payment','e'), ENT_QUOTES) ?>
		<?php
		  }
		 elseif($screen=='new_payment')
		  {
		  ?>
			<?php htmlspecialchars( xl('Batch Payment Entry','e'), ENT_QUOTES) ?>
		<?php
		  }
		 else
		  {
		  ?>
			<?php htmlspecialchars( xl('Edit Payment','e'), ENT_QUOTES) ?>
		<?php
		  }
		  ?>
		</font></td>
	  ...
	  <tr>
		...
		<td align="left" class='text'><?php htmlspecialchars( xl('Date:','e'), ENT_QUOTES) ?></td>
	   ...
	   <script>
		...
		<td></td>
	    <td align="left" class='text'><?php htmlspecialchars( xl('Post To Date:','e'), ENT_QUOTES) ?></td>
	   ...
	   <script>
	    ...
	    <td>
		<?php
		if($PaymentMethod=='Check_Payment' || $PaymentMethod=='Bank Draft' || $CheckNumber!='' || $screen=='new_payment')
		 {
		  $CheckDisplay='';
	  ...
	  <tr>
		...
		<td align="left"><input   type="text" name="payment_amount"   autocomplete="off"  id="payment_amount" onKeyUp="ValidateNumeric(this);<?php echo $screen=='new_payment'?'FillUnappliedAmount();':'FillAmount();';?>"  value="<?php echo $screen=='new_payment'?htmlspecialchars('0.00'):htmlspecialchars($PayTotal);?>"  style="text-align:right"    class="class1 text "   /></td>
	    <td align="left" ></td>
	    <td align="left" ></td>
	  ...
	  <tr>
	    <td align="left" class='text'></td>
		<td align="left" class='text'><?php htmlspecialchars( xl('Deposit Date:','e'), ENT_QUOTES) ?></td>
	   ...
	   <script>
		...
		<td></td>
	    <td align="left" class="text"><?php htmlspecialchars( xl('Description:','e'), ENT_QUOTES) ?></td>
	...
	?>
	  <tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="280">
		  ...
		  <tr>
			<td width="100"><a href="#" onClick="javascript:return SavePayment();" class="css_button"><span><?php htmlspecialchars( xl('Save Changes','e'), ENT_QUOTES);?></span></a></td>
		    <td width="110"><a href="#" onClick="javascript:ResetForm()" class="css_button"><span><?php htmlspecialchars( xl('Cancel Changes','e'), ENT_QUOTES);?></span></a></td>
		    <td width="70"><a href="#" class="css_button" onClick="javascript:OpenEOBEntry();"><span><?php htmlspecialchars( xl('Allocate','e'), ENT_QUOTES);?></span></a></td>
		  </tr>
		</table>		</td>
	  </tr>
	<?php
	  ...
	  <tr>
		<td colspan="13" align="left" >
			...
			<table width="969" border="0"  cellspacing="0" cellpadding="0" align="left">
				  <tr>
					<td colspan="13" align="left">&nbsp;<font class='title'><?php htmlspecialchars( xl('Batch Payment Entry','e'), ENT_QUOTES) ?></font></td>
				  </tr>
				  <tr height="20">
					<td align="left" width="5" ></td>
