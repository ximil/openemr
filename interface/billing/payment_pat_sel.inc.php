  ...
  if ($_POST["mode"] == "search" && $_REQUEST['hidden_patient_code']*1>0)
   {
	...
	$ResultSearchNew = sqlStatement("SELECT billing.id,last_level_closed,billing.encounter,form_encounter.`date`,billing.code,billing.modifier,fee
	 FROM billing ,form_encounter
			 ...
			 form_encounter.pid ='$hidden_patient_code' $StringForQuery ORDER BY form_encounter.`date`,form_encounter.encounter,billing.code,billing.modifier");
	  ...
	  <tr height="5">
		<td colspan="13" align="left" >
			<table width="705" border="0" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE"  id="TablePatientPortion">
			  ...
			  <tr>
				<td width="45" align="left" class="text">&nbsp;<?php htmlspecialchars( xl('Patient:','e'), ENT_QUOTES) ?>
				</td>
				...
				|| $_REQUEST['RadioPaid']=='' ? 'checked' : '' ; ?>  value="Non_Paid" id="Non_Paid"  /><?php htmlspecialchars( xl('Non Paid','e'), ENT_QUOTES) ?></td>
				...
				id="Show_Primary_Complete" /><?php htmlspecialchars( xl('Show Primary Complete','e'), ENT_QUOTES) ?></td>
				<td width="157" class="text"><input type="radio" name="RadioPaid" onClick="SearchOnceMore()" 
				<?php echo $_REQUEST['RadioPaid']=='Show_Paid' ? 'checked' : '' ; ?>  value="Show_Paid" id="Show_Paid" /><?php htmlspecialchars( xl('Show All Transactions','e'), ENT_QUOTES) ?>
				</td>
			  </tr>
			  <tr>
	...
	<td colspan="13" align="left" >
			...
			<table width="1004"  border="0" cellpadding="0" cellspacing="0" align="center" id="TableDistributePortion">
			  ...
			  <tr class="text" bgcolor="#dddddd">
				<td width="55" class="left top" ><?php htmlspecialchars( xl('Post For','e'), ENT_QUOTES) ?></td>
				<td width="80" class="left top" ><?php htmlspecialchars( xl('Service Date','e'), ENT_QUOTES) ?></td>
				<td width="65" class="left top" ><?php htmlspecialchars( xl('Encounter','e'), ENT_QUOTES) ?></td>
				<td width="70" class="left top" ><?php htmlspecialchars( xl('CPT Code','e'), ENT_QUOTES) ?></td>
				<td width="55" class="left top" ><?php htmlspecialchars( xl('Charge','e'), ENT_QUOTES) ?></td>
				<td width="40" class="left top" ><?php htmlspecialchars( xl('Copay','e'), ENT_QUOTES) ?></td>
				<td width="45" class="left top" ><?php htmlspecialchars( xl('Remdr','e'), ENT_QUOTES) ?></td>
				...
				<td width="209" class="left top right" ><?php htmlspecialchars( xl('Follow Up Reason','e'), ENT_QUOTES) ?></td>
			  </tr>
			  <?php
				do 
				 {
