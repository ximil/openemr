...
///////////////////////// Assorted Functions /////////////////////////
	...
	global $InsertionId;//last inserted ID of 
		...
		if($WarningFlag==true)
			$StringToEcho.="<tr bgcolor='#ff0000'><td colspan='4' align='center'>".htmlspecialchars( xl('Warning Cheque No already exist in the database'), ENT_QUOTES)."</td></tr>";
 		$StringToEcho.="</table>";
		}
		else
		{
  ...
  echo $StringToEcho;
	...
	?>
		<table border='0' cellpadding='2' cellspacing='0' width='100%'>
		 ...
		 <tr bgcolor="#cccccc">
		  <td class="dehead">
		   <?php htmlspecialchars( xl('Patient','e'), ENT_QUOTES) ?>
		  </td>
		  <td class="dehead">
		   <?php htmlspecialchars( xl('Invoice','e'), ENT_QUOTES) ?>
		  </td>
		  <td class="dehead">
		   <?php htmlspecialchars( xl('Code','e'), ENT_QUOTES) ?>
		  </td>
		  <td class="dehead">
		   <?php htmlspecialchars( xl('Date','e'), ENT_QUOTES) ?>
		  </td>
		  <td class="dehead">
		   <?php htmlspecialchars( xl('Description','e'), ENT_QUOTES) ?>
		  </td>
		  <td class="dehead" align="right">
		   <?php htmlspecialchars( xl('Amount','e'), ENT_QUOTES) ?>&nbsp;
		  </td>
		  <td class="dehead" align="right">
		   <?php htmlspecialchars( xl('Balance','e'), ENT_QUOTES) ?>&nbsp;
		  </td>
		 </tr>
			  ...
			  foreach($InsertionId as $key => $value)
				{
					...
					{
					$StringIssue.=htmlspecialchars( xl("Total distribution for check No."), ENT_QUOTES).' '.$key.' '.
									htmlspecialchars( xl(" is not full."), ENT_QUOTES).'\n';
					}
				}
			if($StringIssue!='')
