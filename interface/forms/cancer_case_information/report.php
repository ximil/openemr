...
function cancer_case_information_report($pid, $encounter, $cols, $id) {
    $count = 0;
    $data = sqlQuery("SELECT * FROM `form_cancer_case_information` WHERE id=? AND pid = ? ORDER BY DATE DESC LIMIT 0,1", array($id,$GLOBALS['pid']));
    if ($data) {
