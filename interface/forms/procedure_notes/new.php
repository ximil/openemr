...
formHeader("Form:Procedure Notes Form");
...
<html>
  ...
  <body class="body_top">
    <p><span class="forms-title"><?php echo xlt('Procedure Notes Form'); ?></span></p>
    <br> 
    <form method="post" name="my_form" action="<?php echo $rootdir;?>/forms/procedure_notes/save.php?id="<?php echo attr($formid);?> >
