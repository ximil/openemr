            ...
            case 'fax_details':
                ...
                if($req_list == "facility") {
                    ...
                    foreach($facility as $fac_query_result){
                        echo "<option value='".htmlspecialchars($fac_query_result['fax'],ENT_NOQUOTES)."' >".$fac_query_result['name']."</option>";
                    }
                } else {
                    ...
                    foreach($users as $user){
                        ...
                        echo "<option value='".htmlspecialchars($user['fax'])."' >".$displayName."</option>";    
                    }
                }
                break;
        }
