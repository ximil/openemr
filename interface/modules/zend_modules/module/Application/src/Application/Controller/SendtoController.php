...
class SendtoController extends AbstractActionController
{
    ...
    */
    public function sendAction()
    {
        ...
        $components             = $this->getSendtoTable()->getCombinationFormComponents($encounter,$selected_cform);
        $combinationFormData    = $this->getSendtoTable()->getCombinationForms($encounter);
        ...
        $view =  new ViewModel(array(
                                'combinationFormData' => $combinationFormData,
    ...
    public function ajaxAction(){
        ...
        switch ($ajax_mode) {
            ...
            case 'send_fax':
                ...
                //sendAsFax($_POST['fax_no'],$content,$attention,'Combination Form');
                break;
            case 'fax_details':
                ...
                if($req_list == "facility") {
                    ...
                    foreach($facility as $fac_query_result){
                        echo "<option value='".$this->escapeHtml($fac_query_result['fax'])."' >".$this->listenerObject->z_xlt($fac_query_result['name'])."</option>";
                    }
                } else {
                    ...
                    foreach($users as $user){
                        ...
                        echo "<option value='".$this->escapeHtml($user['fax'])."' >".$this->listenerObject->z_xlt($displayName)."</option>";    
                    }
                }
                break;
        }
