...
class ApplicationTable extends AbstractTableGateway
{
    ...
    public function listAutoSuggest($post, $limit)
    {
      ...
      elseif ($searchType == strtolower('emrdirect')) {
    ...
    */
    ...
    /*
    * Generate Sequence ID using ADODB's GenID function from the file openemr/library/adodb/drivers/adodb-mysql.inc.php
    ...
    */
    public function generateSequenceID($seqname='adodbseq', $start_id=1)
    {
        return $GLOBALS['adodb']['db']->GenID($seqname, $start_id);
    }
}
