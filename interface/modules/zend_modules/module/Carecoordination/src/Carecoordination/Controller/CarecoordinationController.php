...
class CarecoordinationController extends AbstractActionController
{
    ...
    */
    ...
    public function revandapproveAction()
    {
      ...
      $gender_list                         = \Application\Plugin\CommonPlugin::getList('sex',$demographics_old[0]['sex'],'');
      $country_list                        = \Application\Plugin\CommonPlugin::getList('country',$demographics_old[0]['country_code'],'');
      $marital_status_list                 = \Application\Plugin\CommonPlugin::getList('marital',$demographics_old[0]['status'],'');
      $religion_list                       = \Application\Plugin\CommonPlugin::getList('religious_affiliation',$demographics_old[0]['religion'],'');
      $race_list                           = \Application\Plugin\CommonPlugin::getList('race',$demographics_old[0]['race'],'');
      $ethnicity_list                      = \Application\Plugin\CommonPlugin::getList('ethnicity',$demographics_old[0]['ethnicity'],'');
