...
{  
  /**
   * saveDocument Save Files to Documents Table
   * @param Array Files
   */
  public function saveDocument($FILES)
  {    
    ...
    foreach($FILES as $FILE) {
      $genid = $obj->generateSequenceID('sequences');
      $result = $obj->zQuery($sql,array(
                  $genid,
                  $FILE['pid'],
                  $FILE['doc_type'],
                  $FILE['size'],
      ...
      \Documents\Model\DocumentsTable::insertDocumentCategory($FILE['category_id'], $genid);
    }
    return $genid;
  }
