...
class SyndromicsurveillanceController extends AbstractActionController
{
    ...
    */
    public function indexAction()
    {
        ...
        $fromDate       = $request->getPost('form_date_from', null) ? $request->getPost('form_date_from', null) : date('Y-m-d',strtotime(date('Ymd')) - (86400*7));		
        $toDate         = $request->getPost('form_date_to', null) ? $request->getPost('form_date_to', null) : date('Y-m-d');
