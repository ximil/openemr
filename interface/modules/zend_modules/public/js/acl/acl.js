...
*/
    ...
    function saveAcl(){
      if(selected_component == '') {
        var resultTranslated = langTranslator('Select a Component');
        alert(resultTranslated);
        return;
      }
      ...
      $.ajax({
               ...
               success: function(thedata){
                  var resultTranslated = langTranslator('ACL Updated Successfully');
                  $("#messages").html(resultTranslated);
	...
	$.ajax({
	       ...
	       module_id:module_id
               ...
               success: function(thedata){
                  var resultTranslated = langTranslator('ACL Updated Successfully');
                  $("#messages_div").html(resultTranslated);
    ...
    var resultTranslated = langTranslator('Section ID and Name Cannot be Empty');
		alert(resultTranslated);
		return;
	}
	$.ajax({
		...
		section_name:section_name,
               ...
               async: false,
               success: function(thedata){
        var resultTranslated = langTranslator('Section saved successfully');
		    $("#add_component_section_message").html(resultTranslated);
