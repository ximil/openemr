...
class Emr extends AbstractHelper
{
    /*
    * function getList
    * to get Particular list as an Array
    * @param $list_id
    * @value Id of a List
    * @param $selected
    * @value Id of a selected item
    * @param $opt
    * @value Option
    */
    ...
    * to get list of Providers as an Array
    * @param void
    */
    ...
    */
    ...
    /*
    * function getDropdownValAsText
    * to get option title of a particular list
    * @param $list_id
    * @value ID of a list
    * @param $option_id
