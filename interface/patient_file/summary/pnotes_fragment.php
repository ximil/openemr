...
<div class='tabContainer' >
  <div class='tab current' >
    ...
    if ($result != null) {
      ...
      echo "<td valign='top' class='text' ><b>From</b></td>\n";
      echo "<td valign='top' class='text' ><b>Date</b></td>\n";
      echo "<td valign='top' class='text' ><b>Subject</b></td>\n";
      echo "<td valign='top' class='text' ><b>Content</b></td>\n";
      echo "<td valign='top' class='text' ><b>Status</b></td>\n";
      echo "</tr>\n";
      foreach ($result as $iter) {
        ...
        echo "<td valign='top' class='text'>".htmlspecialchars(xl($iter['user']),ENT_NOQUOTES)."</td>\n";
        echo "<td valign='top' class='text'>".htmlspecialchars(xl($iter['date']),ENT_NOQUOTES)."</td>\n";
        ...
        echo "<td valign='top' class='text'>".htmlspecialchars(xl($iter['message_status']),ENT_NOQUOTES)."</td>\n";
        echo " </tr>\n";
...
<?php } ?>
  ...
  <div class='tab'>
    ...
    if ($result_sent != null) {
      ...
      echo "<tr class='text' style='border-bottom:2px solid #000;' >\n";
      echo "<td valign='top' class='text' ><b>To</b></td>\n";
      echo "<td valign='top' class='text' ><b>Date</b></td>\n";
      echo "<td valign='top' class='text' ><b>Subject</b></td>\n";
      echo "<td valign='top' class='text' ><b>Content</b></td>\n";
      echo "</tr>\n";
      foreach ($result_sent as $iter) {
        ...
        echo " <tr class='text' id='".htmlspecialchars($iter['id'],ENT_QUOTES)."' style='border-bottom:1px dashed;height:30px;' >\n";
        // Modified 6/2009 by BM to incorporate the patient notes into the list_options listings
        echo "<td valign='top' class='text'>".htmlspecialchars(xl($iter['assigned_to']),ENT_NOQUOTES)."</td>\n";
        echo "<td valign='top' class='text'>".htmlspecialchars(xl($iter['date']),ENT_NOQUOTES)."</td>\n";
        echo "  <td valign='top' class='text'><b>";
        echo generate_display_field(array('data_type'=>'1','list_id'=>'note_type'), $iter['title']);
        echo "</b></td>\n";
