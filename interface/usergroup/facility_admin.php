	...
	?>
	 ...
	 <tr>
	  ...
	  <td>[<a href="javascript:void(0);" onClick="pick('pick','newcolor');return false;" NAME="pick" ID="pick"><?php  echo htmlspecialchars(xl('Pick'),ENT_QUOTES); ?></a>]</td><td>&nbsp;</td>
        ...
        <tr>
            <td><span class="text"><?php xl('Facility Code','e'); ?>:</span></td>
            <td colspan="4"><input type="text" name="fac_code" size="20" value="<?php echo htmlspecialchars($facility['facility_code'], ENT_QUOTES) ?>"></td>
        </tr>
