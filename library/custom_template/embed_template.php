...
// Added for LETTERS AND TEMPLATES
if($contextName == 'Letters And Templates'){
  $sql = "SELECT COUNT(`cl_list_slno`) AS count FROM customlists WHERE `cl_list_item_long` = 'Letters And Templates' ";
  $res = sqlQuery($sql);
  if($res['count'] < 1){
    $id = sqlInsert(" INSERT INTO customlists (`cl_list_type`,`cl_list_item_long`) VALUES(?,?) ",array(2,$contextName));
            ...
            <td>
				...
				if(!$save_button_name)
				    $save_button_name='SAVE';
                                ?>
                                <a href="#" onclick="return SaveInEmbed('<?php echo $type;?>')" class="css_button" id="nationnoteok" ><span><?php echo htmlspecialchars(xl($save_button_name),ENT_QUOTES);?></span></a>
				<a href="#" onclick="return CancelNotes('<?php echo $type;?>')" class="css_button" ><span><?php echo htmlspecialchars(xl('CANCEL'),ENT_QUOTES);?></span></a>
                            </td>
                        </tr>
                        <tr class="text">
                            <td id="templateDD">
				...
				<a href="#" id="enter" onclick="top.restoreSession();ascii_write('13','textarea1');" title="<?php echo htmlspecialchars(xl('Enter Key'),ENT_QUOTES);?>"><img border=0 src="../../images/enter.gif"></a>&nbsp;
                                <a href="#" id="quest" onclick="top.restoreSession();AppendStringToContent('? ');" title="<?php echo htmlspecialchars(xl('Question Mark'),ENT_QUOTES);?>"><img border=0 src="../../images/question.png"></a>&nbsp;
				...
				?>
                                <textarea class="<?php echo $class;?>" id="textarea1" name="textarea1" rows="20" cols="53"></textarea>
                            </td>                            
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
