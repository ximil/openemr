    ...
    <body class="body_top">
        <form name="myform" method="post">
            ...
            <table align="center" width="100%">
                <tr class="text">
                    <td colspan="3">
                        <a href=# class="css_button" onclick="personalize_save()"><span><?php echo htmlspecialchars(xl('Save'),ENT_QUOTES);?></span></a>
                        <?php
                        if(acl_check('docwriter', 'dwr')){
                        ?>
			...
			<?php
                ...
                <tr class="text">
                    ...
                    ?>
                    <th><?php echo htmlspecialchars($user['fname']." ".$user['lname']."'s Categories",ENT_QUOTES);?></th>
                </tr>
                <tr class="text">
                    <td align=right>
