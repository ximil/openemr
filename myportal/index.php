...
require_once("../interface/globals.php");
 ...
 function md5_pass($length = 8)
 {
  ...
  $res = sqlStatement("SELECT * FROM audit_master AS am LEFT OUTER JOIN audit_details AS ad ON ad.audit_master_id=am.id WHERE type=5 AND field_value='".$randkey."'");
  if(sqlNumRows($res)){
  md5_pass();
  }
  else{
  $grpID = sqlInsert("INSERT INTO audit_master SET type=5");
  sqlStatement("INSERT INTO audit_details SET field_value='".$randkey."' , audit_master_id='".$grpID."'");
  return $randkey;
  }
 }
?>
