...
) ENGINE=MyISAM  ROW_FORMAT=DYNAMIC COMMENT='List of Master Docs to be signed' AUTO_INCREMENT=1 ;
#EndIf
...
CREATE TABLE `audit_master` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '1-new patient,2-existing patient,5-random key',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1;
#EndIf
