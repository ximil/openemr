...
#IfNotRow2D list_options list_id lists option_id Specialty
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`) 
VALUES ('lists','Specialty','Specialty','10','0','0','','');
#EndIf

#IfMissingColumn registry specialty
ALTER TABLE `registry` ADD COLUMN `specialty` VARCHAR(45) NOT NULL DEFAULT '';
#EndIf
