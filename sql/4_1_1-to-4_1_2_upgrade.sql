...
Alter table `amc_misc_data` MODIFY `date_created` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType amc_misc_data date_completed TIMESTAMP 
Alter table `amc_misc_data` MODIFY `date_completed` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `billing` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType billing bill_date TIMESTAMP 
Alter table `billing` MODIFY `bill_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType billing process_date TIMESTAMP 
Alter table `billing` MODIFY `process_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `claims` MODIFY `bill_time` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType claims process_time TIMESTAMP 
Alter table `claims` MODIFY `process_time` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `documents` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `eligibility_verification` MODIFY `eligibility_check_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType employer_data date TIMESTAMP
Alter table `employer_data` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType extended_log date TIMESTAMP
Alter table `extended_log` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_dictation date TIMESTAMP
Alter table `form_dictation` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_encounter date TIMESTAMP
Alter table `form_encounter` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_encounter onset_date TIMESTAMP
Alter table `form_encounter` MODIFY `onset_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_misc_billing_options date TIMESTAMP
Alter table `form_misc_billing_options` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_reviewofs date TIMESTAMP
Alter table `form_reviewofs` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_ros date TIMESTAMP
Alter table `form_ros` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_soap date TIMESTAMP
Alter table `form_soap` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_vitals date TIMESTAMP
Alter table `form_vitals` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType forms date TIMESTAMP
Alter table `forms` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data cataract_surgery TIMESTAMP
Alter table `history_data` MODIFY `cataract_surgery` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data tonsillectomy TIMESTAMP
Alter table `history_data` MODIFY `tonsillectomy` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data cholecystestomy TIMESTAMP
Alter table `history_data` MODIFY `cholecystestomy` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data heart_surgery TIMESTAMP
Alter table `history_data` MODIFY `heart_surgery` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data hysterectomy TIMESTAMP
Alter table `history_data` MODIFY `hysterectomy` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data hernia_repair TIMESTAMP
Alter table `history_data` MODIFY `hernia_repair` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data hip_replacement TIMESTAMP
Alter table `history_data` MODIFY `hip_replacement` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data knee_replacement TIMESTAMP
Alter table `history_data` MODIFY `knee_replacement` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data appendectomy TIMESTAMP
Alter table `history_data` MODIFY `appendectomy` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType history_data date TIMESTAMP
Alter table `history_data` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType immunizations create_date TIMESTAMP
Alter table `immunizations` MODIFY `create_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType lists date TIMESTAMP
Alter table `lists` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType lists_touch date TIMESTAMP
Alter table `lists_touch` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType log date TIMESTAMP
Alter table `log` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType notes date TIMESTAMP
Alter table `notes` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `onotes` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType openemr_postcalendar_events pc_time TIMESTAMP
Alter table `openemr_postcalendar_events` MODIFY `pc_time` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType patient_data date TIMESTAMP
Alter table `patient_data` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType patient_data financial_review TIMESTAMP
Alter table `patient_data` MODIFY `financial_review` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType patient_data deceased_date TIMESTAMP
Alter table `patient_data` MODIFY `deceased_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType patient_reminders date_inactivated TIMESTAMP
Alter table `patient_reminders` MODIFY `date_inactivated` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType patient_reminders date_created TIMESTAMP
Alter table `patient_reminders` MODIFY `date_created` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType patient_reminders date_sent TIMESTAMP
Alter table `patient_reminders` MODIFY `date_sent` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `pnotes` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType prescriptions datetime TIMESTAMP
Alter table `prescriptions` MODIFY `datetime` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType procedure_order date_collected TIMESTAMP
Alter table `procedure_order` MODIFY `date_collected` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType procedure_report date_collected TIMESTAMP
Alter table `procedure_report` MODIFY `date_collected` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType procedure_result date TIMESTAMP
Alter table `procedure_result` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType registry date TIMESTAMP
Alter table `registry` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType rule_patient_data date TIMESTAMP
Alter table `rule_patient_data` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType standardized_tables_track imported_date TIMESTAMP
Alter table `standardized_tables_track` MODIFY `imported_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType standardized_tables_track revision_date TIMESTAMP
Alter table `standardized_tables_track` MODIFY `revision_date` TIMESTAMP NULL DEFAULT NULL;
#EndIf
...
Alter table `transactions` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_note date TIMESTAMP
Alter table `form_note` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_note date_of_signature TIMESTAMP
Alter table `form_note` MODIFY `date_of_signature` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_aftercare_plan date TIMESTAMP
Alter table `form_aftercare_plan` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_ankleinjury date TIMESTAMP
Alter table `form_ankleinjury` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_ankleinjury ankle_date_of_injuary TIMESTAMP
Alter table `form_ankleinjury` MODIFY `ankle_date_of_injuary` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_bronchitis date TIMESTAMP
Alter table `form_bronchitis` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_CAMOS date TIMESTAMP
Alter table `form_CAMOS` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_CAMOS_category date TIMESTAMP
Alter table `form_CAMOS_category` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_CAMOS_subcategory date TIMESTAMP
Alter table `form_CAMOS_subcategory` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_CAMOS_item date TIMESTAMP
Alter table `form_CAMOS_item` MODIFY `date` TIMESTAMP NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_prior_auth date TIMESTAMP
Alter table `form_prior_auth` MODIFY `date` TIMESTAMP NOT NULL default '0000-00-00 00:00:00';
#EndIf

#IfNotColumnType form_transfer_summary date TIMESTAMP
Alter table `form_transfer_summary` MODIFY `date` timestamp NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_treatment_plan date TIMESTAMP
Alter table `form_treatment_plan` MODIFY `date` timestamp NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_vitalsM date TIMESTAMP
Alter table `form_vitalsM` MODIFY `date` timestamp NULL DEFAULT NULL;
#EndIf

#IfNotColumnType form_painmap date TIMESTAMP
Alter table `form_painmap` MODIFY `date` timestamp NULL DEFAULT NULL;
#EndIf