...
#IfNotRow patient_portal_menu menu_name Dashboard
...
#IfNotTable patient_portal_menu_group	 
...
#IfNotRow patient_portal_menu_group menu_group_name Demographics
...
ALTER TABLE `log` ADD COLUMN `log_from` varchar(20) DEFAULT 'open-emr'; 
#EndIf

#IfMissingColumn log menu_item_id                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
ALTER TABLE `log` ADD COLUMN `menu_item_id` int(11) DEFAULT NULL;
#EndIf