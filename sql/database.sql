...
CREATE TABLE `patient_data` (
  ...
  `portal_pwd` VARCHAR(100) NULL,
  `portal_pwd_status` TINYINT DEFAULT '1' NULL COMMENT '0=>Password Created Throug Demo Patient Should Change it.1=>Pwd updated or created by patient itself',
  UNIQUE KEY `pid` (`pid`),
  KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `employer_data_register`
--
...
--
-- Table structure for table `insurance_data_register`
--
...
--
-- Table structure for table `patient_data_register`
--
...
--
-- Table structure for table `zh_categories`
--
...
--
-- Dumping data for table `zh_categories`
--
