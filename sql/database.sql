...
INSERT INTO `layout_options` VALUES ('DEM', 'status', '1Who', 'Marital Status', 10, 1, 1, 0, 0, 'marital_status_ccda', 1, 3, '', '', 'Marital Status', 0);
...
INSERT INTO `layout_options` VALUES ('DEM', 'ethnicity', '5Stats', 'Ethnicity', 2, 33, 1, 0, 0, 'ethnicity_ccda', 1, 1, '', '', 'Ethnicity', 0);
INSERT INTO `layout_options` VALUES ('DEM', 'race', '5Stats', 'Race', 3, 33, 1, 0, 0, 'race_ccda', 1, 1, '', '', 'Race', 0);
...
INSERT INTO `layout_options` VALUES ('DEM', 'religion', '5Stats', 'Religion', 13, 1, 1, 20, 0, 'religious_affiliation', 1, 1, '', '', '', 0);
...
CREATE TABLE `users` (
  ...
  `physician_type` VARCHAR(15) DEFAULT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 ;
...
-- --------------------------------------------------------
--
-- Table structure for table `list_codes`
--
