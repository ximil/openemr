...
CREATE TABLE `documents` (
  ...
  `couch_docid` VARCHAR(40) DEFAULT NULL,
  `couch_revid` VARCHAR(40) DEFAULT NULL,
  `storagemethod` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '0->Harddisk,1->CouchDB and 2->Both Harddisk and CouchDB',
  PRIMARY KEY  (`id`),
